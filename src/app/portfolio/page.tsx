  ...
  return (
    <div className="portfolio-page">
      ...
      <section className="hero-section">
        <h1>Marcel Brard</h1>
        <p>
          IT Engineer | Full-Stack Developer | Procedure Analysis Expert
        </p>
      </section>
      ...
      <section className="projects-section">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            <h3>Prep & Plate 🥗</h3>
            <p>
              A Django-based recipe and meal planning application for culinary enthusiasts.
            </p>
            <a href="https://github.com/Imperial-Marv/Prep-Plate-/tree/main" target="_blank"
          ...
          <div className="project-card">
            <h3>Petscorp 🐾</h3>
            <p>
            A Django-powered web application for a pet store. Features donor management, pet details, and a user-friendly shopping experience.
            </p>
            <a
...
<div className="hobby-card">
    ...
    <div className="hobby-icons">
      ...
      <footer className="contact-section">
        <h2>Get in Touch</h2>
        <p>
          <a href="mailto:marcel_brard@outlook.com" aria-label="Send an email to Marcel">
            ✉︎
          </a>
        </p>
        <p>
          LinkedIn: <a href="https://www.linkedin.com/in/marcelbrard" target="_blank" rel="noopener noreferrer">linkedin.com/in/marcelbrard</a>
        </p>
      </footer>
    </div>
  );
